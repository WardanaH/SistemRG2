                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    <label class="form-label fw-bold text-danger">Minta Bantuan Ke Cabang:</label>
                                    <select name="inputcabangbantuan" id="inputcabangbantuan" class="form-select select2" required>
...
<script>
    $(function() {
        ...
        const storeUrl = "{{ route('bantuan.store') }}";
        ...
        form.on('submit', function(e) {
            ...
            // TAMBAHKAN VALIDASI CABANG SEBELUM AJAX
            if ($('#inputcabangbantuan').val() == "") {
                Swal.fire('Warning', 'Silakan pilih cabang tujuan bantuan!', 'warning');
                return;
            }
            ...
            $.ajax({
                ...
                success: function(response) {
                    Swal.fire({
                        ...
                        window.location.href = "{{ route('bantuan') }}";
                    });
                },
                error: function(xhr) {
