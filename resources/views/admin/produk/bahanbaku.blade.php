      ...
      <form id="formAdd">@csrf
        ...
        <div class="modal-body">
          <div class="row g-2">
            ...
            <div class="col-md-6"><input name="tambah_nama_bahan" class="form-control" placeholder="Nama Bahan"></div>
            <div class="col-md-6">
            ...
            <div class="col-md-6"><input name="tambah_harga" type="number" class="form-control" placeholder="Harga"></div>
            <div class="col-md-6"><input name="tambah_batas_stok" type="number" class="form-control" placeholder="Batas Stok"></div>
            ...
            if (res.data.length === 0) {
                ...
                res.data.forEach(b => {
                    ...
                    <tr>
                      ...
                      <td>${b.keterangan ?? '-'}</td>
                      <td>
                        <button class="btn btn-success btn-sm editBtn" data-id="${b.id}">Edit</button>
    ...
    $('#formAdd').on('submit', function(e) {
        ...
        $.post("{{ route('storebahanbaku') }}", $(this).serialize(), function(res) {
            if (res === "Success") {
                ...
                addModal.hide();
                loadBahan();
            } else alert('Gagal menambahkan bahan baku!');
        });
    });
