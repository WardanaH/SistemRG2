...
<body>
    ...
    <div id="main-wrapper">
        @auth
            @include('admin.inventaris.templateinventaris.layout_cabang.header')
            @include('admin.inventaris.sidebar')
        @endauth
        ...
        @include('admin.inventaris.templateinventaris.layout_cabang.footer')
    </div>
